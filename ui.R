        ...
        fluidRow(
          column(12, align = "center",
             ...
             tab 6 (Prediction O/U Aggregated Models) and tab 9 (Prediction Spread Aggregated Models)
                ...
                picks I agree/disagree with the model on for O/U and spread, player props of the week and what's trending up/trending down in the NFL.", 
...
All picks that have a yes on the 'Mod All Agree High Conf' are in our wheelhouse (Should be highlighted green). 
...
So point being, this is to highlight the difference between regular picks win% and the alpha we found in Mod All Agree, High Conf." ,
                     style = "font-size: 18px; text-align: center;"),
                   p("If you want information on the tiers, injuries, etc, please look in the appendix for more information. 
